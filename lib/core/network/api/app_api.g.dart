...
class _AppServiceClient implements AppServiceClient {
  ...
  Future<UpdateAccountInformationResponse> updateMyData(
    ...
    final _value = UpdateAccountInformationResponse.fromJson(_result.data!);
    return _value;
  }
  ...
  Future<UpdateMyPasswordResponse> updateMyPasswordService(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UpdateMyPasswordResponse>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _value = UpdateMyPasswordResponse.fromJson(_result.data!);
    return _value;
  }
  ...
  Future<DeleteAccountResponse> deleteMyAccountService() async {
    ...
    final _value = DeleteAccountResponse.fromJson(_result.data!);
    return _value;
  }
