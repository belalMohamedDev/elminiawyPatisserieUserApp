...
class AdminProductState with _$AdminProductState {
  ...
  const factory AdminProductState.selectedRangeState(
  ...
  const factory AdminProductState.getAllProductError(
  ...
  const factory AdminProductState.imagePicked() = ImagePicked;

  //get product State
  const factory AdminProductState.updateProductLoading() = UpdateProductLoading;
  const factory AdminProductState.updateProductError(
    ApiErrorModel apiErrorModel,
  ) = UpdateProductError;
