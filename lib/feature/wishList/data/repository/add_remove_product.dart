...
class AddOrRemoveProductFromWishListRepository {
  AddOrRemoveProductFromWishListRepository(this._apiService, this._networkInfo);
  ...
  Future<ApiResult<WishListProduct>> addOrRemoveProductFromWishList(
    ...
    if (await _networkInfo.isConnected) {
      try {
        final response = await _apiService.addOrRemoveProductFromWishList(product);
