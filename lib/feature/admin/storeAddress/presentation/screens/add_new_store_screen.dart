...
class AddNewStoreScreen extends StatelessWidget {
  ...
  Widget _emptyMapState(BuildContext context, VoidCallback onPickLocation) {
    final responsive = ResponsiveUtils(context);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: ColorManger.brun.withValues(alpha: 0.2)),
      ),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(
            Icons.location_off_outlined,
            size: responsive.setIconSize(18),
            color: ColorManger.brun,
          ),
          SizedBox(height: responsive.setHeight(1)),
          Text(
          ...
          SizedBox(height: responsive.setHeight(0.6)),
          Text(
            context.translate("AppStrings.pickStoreLocationHint"),
            style: Theme.of(
              context,
          ...
          ElevatedButton.icon(
            ...
            label: Text(context.translate(AppStrings.pickLocation)),
