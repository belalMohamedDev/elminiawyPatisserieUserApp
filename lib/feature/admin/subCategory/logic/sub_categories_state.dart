...
class SubCategoriesState with _$SubCategoriesState {
  const factory SubCategoriesState.initial() = _Initial;
    ...
    const factory SubCategoriesState.getSubCategoriesLoading() = GetSubCategoriesLoading;
  const factory SubCategoriesState.getSubCategoriesError(ApiErrorModel apiErrorModel) =
